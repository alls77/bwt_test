...
<div class="container">
 ...
 <li role="presentation" class="active"><a aria-controls="home" role="tab" data-toggle="tab">feedback</a></li>
 </ul>
 ...
 <div class="form-group">
 <button type="submit" class="btn btn-default" name="feedback" id="done2">Send</button>
 </div>
 </form>
 </div>
  </div>
